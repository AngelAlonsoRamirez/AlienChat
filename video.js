...
if (url==="") {
        ...
        url = url.replace("www.youtube.com/watch?v=","https://www.youtube.com/embed/");
        url = url.replace("https://m.youtube.com/watch?v=","https://www.youtube.com/embed/");
        url = url.replace("m.youtube.com/watch?v=","https://www.youtube.com/embed/");
        
        url = url.replace("https://m.twitch.tv/","https://player.twitch.tv/?channel=");
        url = url.replace("m.twitch.tv/","https://player.twitch.tv/?channel=");
        url = url.replace("https://www.twitch.tv/","https://player.twitch.tv/?channel=");
        url = url.replace("www.twitch.tv/","https://player.twitch.tv/?channel=");
        
        var todo = "<b>" + usuario + "</b><br>" + fecha +  '</i><br><center><iframe width="100%" height="300" style="border-radius: 6px;" src="' + url + '" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>'
